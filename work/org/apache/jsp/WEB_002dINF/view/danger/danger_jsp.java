package org.apache.jsp.WEB_002dINF.view.danger;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class danger_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\t\t<div class=\"page-header\">\r\n");
      out.write("\t\t\t<h2 class=\"sub-header\">削除確認</h2>\r\n");
      out.write("\t\t\t<p>本当に削除しますか？</p>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t<div class=\"page-header\">\r\n");
      out.write("\t\t\t<h2 class=\"sub-header\">削除対象ユーザ一</h2>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      if (_jspx_eval_s_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t<input type=\"hidden\" name=\"id\" value =selectedId>\r\n");
          out.write("\t\t\t\t\t\t</td>\r\n");
          out.write("\t\t\t\t\t\t<td>");
          out.print( request.getAttribute( "selectedName" ) );
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t<input type=\"hidden\" name=\"name\" value =selectedName />\r\n");
          out.write("\t\t\t\t\t\t</td>\r\n");
          out.write("\t\t\t\t\t");
      ...
      out.write("\t\t\t</tbody>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t\t\t<input type=\"submit\" name=\"delete\" value=\"OK\"/>\r\n");
      out.write("\t\t\t<input type=\"submit\" value=\"戻る\" onClick=\"history.back()\">\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
