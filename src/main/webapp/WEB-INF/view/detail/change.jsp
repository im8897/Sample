...
<body>
	<div class="container">
		...
		<div class="page-header">
			...
			<p>選択されたユーザーの情報を変更できます</p>

					<div class="page-header">
			<h2 class="sub-header">編集</h2>
		...
		<table id="tb" class="table table-striped">
			...
			<thead>
				<tr>
					<td>ID</td>
					<td>
					<input type="text" name="changeId" value=<%= request.getAttribute( "selectedId" ) %> disabled>
					</td>
				</tr>
				<tr>
					<td>お名前</td>
					<td>
					<input type="text" name="changeName" value= <%= request.getAttribute( "selectedName" ) %> >
					</td>
				</tr>
				<tr>
					<td>住所</td>
					<td>
					<input type="text" name="changeAdd" value= <%= request.getAttribute( "selectedAdd" ) %> >
					</td>
				</tr>
				<tr>
					<td>生年月日</td>
					<td>
					<input type="text" name="changeBd" value=<%= request.getAttribute( "selectedBd" ) %> >
					</td>
				</tr>
			</thead>
			</tbody>
				...
				<input type="submit" name="change" value="更新" onClick= "location.href='detail/'">
